<?php //netteCache[01]000342a:2:{s:4:"time";s:21:"0.51640400 1354110380";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:56:"C:\xampp\htdocs\iis\app\templates\Homepage\default.latte";i:2;i:1354108884;}i:1;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:10:"checkConst";}i:1;s:19:"Framework::REVISION";i:2;s:30:"6a33aa6 released on 2012-10-01";}}}?><?php

// source file: C:\xampp\htdocs\iis\app\templates\Homepage\default.latte

?><?php
// prolog CoreMacros
list($_l, $_g) = CoreMacros::initRuntime($template, 'sxd0ryhgm3')
;
// prolog UIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0045270316_content')) { function _lb0045270316_content($_l, $_args) { extract($_args)
?><div id="banner">
...
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lb1406ac19e0_title')) { function _lb1406ac19e0_title($_l, $_args) { extract($_args)
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb0fd9be2add_head')) { function _lb0fd9be2add_head($_l, $_args) { extract($_args)
?><style>
