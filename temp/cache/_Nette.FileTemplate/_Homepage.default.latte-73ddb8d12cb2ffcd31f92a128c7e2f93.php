<?php //netteCache[01]000361a:2:{s:4:"time";s:21:"0.96715000 1354112127";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:75:"/www/sites/6/site13856/public_html/iis/app/templates/Homepage/default.latte";i:2;i:1354112099;}i:1;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:10:"checkConst";}i:1;s:19:"Framework::REVISION";i:2;s:30:"6a33aa6 released on 2012-10-01";}}}?><?php

// source file: /www/sites/6/site13856/public_html/iis/app/templates/Homepage/default.latte

?><?php
// prolog CoreMacros
list($_l, $_g) = CoreMacros::initRuntime($template, 'xsnn3z0k59')
;
// prolog UIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7f70b17f1b_content')) { function _lb7f70b17f1b_content($_l, $_args) { extract($_args)
?><div id="banner">
...
<div id="content">
	...
	<section id="template">
		<h2>This page template located at <span><?php echo TemplateHelpers::escapeHtml(strstr($presenter->template->getFile(), 'app'), ENT_NOQUOTES) ?></span></h2>

		<pre><code class="jush"><?php echo TemplateHelpers::escapeHtml(file_get_contents($presenter->template->getFile()), ENT_NOQUOTES) ?></code></pre>
	</section>

	<section id="layout">
		<h2>Layout template located at <span><?php echo TemplateHelpers::escapeHtml(strstr($template->getFile(), 'app'), ENT_NOQUOTES) ?></span></h2>

		<pre><code class="jush"><?php echo TemplateHelpers::escapeHtml(file_get_contents($template->getFile()), ENT_NOQUOTES) ?></code></pre>
	</section>

	<section id="presenter">
		<h2>Current presenter located at <span><?php echo TemplateHelpers::escapeHtml(strstr($presenter->reflection->fileName, 'app'), ENT_NOQUOTES) ?></span></h2>

		<pre><code class="jush-php"><?php echo TemplateHelpers::escapeHtml(file_get_contents($presenter->reflection->fileName), ENT_NOQUOTES) ?></code></pre>
	</section>

	<footer>PHP <?php echo TemplateHelpers::escapeHtml(PHP_VERSION, ENT_NOQUOTES) ?> |
		<?php if (isset($_SERVER['SERVER_SOFTWARE'])): ?>Server <?php echo TemplateHelpers::escapeHtml($_SERVER['SERVER_SOFTWARE'], ENT_NOQUOTES) ;endif ?> |
		Nette Framework <?php echo TemplateHelpers::escapeHtml(Framework::VERSION, ENT_NOQUOTES) ?></footer>
</div>
...
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lba69a1b7030_title')) { function _lba69a1b7030_title($_l, $_args) { extract($_args)
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb2fdd8ad882_head')) { function _lb2fdd8ad882_head($_l, $_args) { extract($_args)
?><style>
...
// main template
//
if ($_l->extends) { ob_end_clean(); return CoreMacros::includeTemplate($_l->extends, get_defined_vars(), $template)->render(); }
